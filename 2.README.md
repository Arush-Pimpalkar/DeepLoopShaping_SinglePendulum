...
Transient tests can be performed by applying external actions to the pendulum. I added a torque of +50Nm at the 5th second (red lines). The model is able to correct its position. 
